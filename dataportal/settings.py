...
# The file parameters.py must be present in the site-packages directory
# of the virtual environment. Inside the dictionary credentials must be
# present holding all secret parameters. (Cezar)
from parameters import credentials
