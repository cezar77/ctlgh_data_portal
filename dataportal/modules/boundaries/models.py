...
class Country(models.Model):
    ...
    name_obsolete = models.CharField(max_length=150, blank=True)
    name_variants = models.CharField(max_length=160, blank=True)
    name_nonlatin = models.CharField(max_length=50, blank=True)
    ...
    wbother = models.CharField(max_length=254, blank=True)
